...
endpoint = 'http://openapi.gbis.go.kr/ws/rest/baseinfoservice?serviceKey={}'.format(serviceKey)
print(endpoint)
...
jsonString = json.dumps(dict['response']['msgBody']['baseInfoItem'], ensure_ascii=False) # dict을 json으로 변환
